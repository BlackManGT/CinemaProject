...
public class IsFollowPresenter extends BasePresenter{
    public IsFollowPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iBaseView.isFollow((int) args[0],(String) args[1],(int) args[2]);
    }
}
