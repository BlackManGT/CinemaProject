...
public class SysMsgListPresenter extends BasePresenter{
    public SysMsgListPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iBaseView.SystemMessage((int) args[0],(String) args[1],(int) args[2],(int) args[3]);
    }
}
