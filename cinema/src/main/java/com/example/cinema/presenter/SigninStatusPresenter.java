...
public class SigninStatusPresenter extends BasePresenter {
    public SigninStatusPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iBaseView.SigninStatus((int)args[0],(String)args[1]);
    }
}
