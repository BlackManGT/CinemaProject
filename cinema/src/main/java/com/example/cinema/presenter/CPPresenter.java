...
public class CPPresenter extends BasePresenter {
    public CPPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iBaseView.CPBeans((int)args[0],(String) args[1],(int)args[2],(int)args[3],(int)args[4]);
    }
}
